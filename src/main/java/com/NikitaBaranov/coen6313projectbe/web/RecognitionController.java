package com.NikitaBaranov.coen6313projectbe.web;
...
import com.NikitaBaranov.coen6313projectbe.service.RecognitionService;
...
public class RecognitionController {
    ...
    @GetMapping("/{id}")
    public RecognitionEntity getOne(@PathVariable String id) {
        return recognitionService.getOne(id);
    }

    @PostMapping
    public RecognitionResult recognise(@RequestBody RecognitionEntity recognitionEntity) throws IOException {
        return recognitionService.recognise(recognitionEntity);
    }
}
